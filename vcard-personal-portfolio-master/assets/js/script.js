...
// add click event to all modal items (if any)
if (testimonialsItem && testimonialsItem.length) {
  for (let i = 0; i < testimonialsItem.length; i++) {
    // guard: ensure modal elements exist before reading/writing
...
// add click event to modal close button (if present)
...
if (form && formInputs && formInputs.length) {
